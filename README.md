...
| | **ServerSide (Back-End)** | **Jonatas**: Desenvolvimento do CRUD (Create, Read, Update, Delete) para o chat, utilizando MS SQL Server.<br>**Matheus**: Desenvolvimento do CRUD para perfis, utilizando MS SQL Server. |
...
- **Backend**: Python
- **Banco de Dados**: MS Server Server
